...
<ul class="accordion" data-accordion="">
    ...
    <li class="accordion-navigation"><a class="accordion-link" href="#panel-1-3" aria-expanded="false">Connecting your Live Poll course to Canvas</a>
        <div class="content" id="panel-1-3">
         ...
         <i> Note: if the scroll feature does not work for you browser, then copy and paste in the URL here: https://imathas.fiu.edu/bltilaunch.php followed by clicking on "Add Item": </i> <br>
